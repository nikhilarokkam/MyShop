...
buplishable_key ='pk_test_51NILQUSEu0V1pjcNnYpMAKtVA2w6EG3Nt0jAYhsI0qsEjoNsk2RW6E0LkcJ86x06tfAyQrXU3NjxzbrTqb5sLhUl00JB9jrO3i'
stripe.api_key ='sk_test_51NILQUSEu0V1pjcN3dxq7ciNpiXJJVau3SonXVG92zPrKbasoTVT0pYlgfPxTp2r9IVhp9pgq2eXSuKXqiBtWhbd00h7BfZ4gJ'
...
def payment():
    ...
    # Check if the order exists before updating its status
